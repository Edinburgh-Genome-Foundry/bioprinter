...
latex_documents = [
    ("index", "bioprinter.tex", u"bioprinter Documentation", u"Zulko", "manual"),
]
...
man_pages = [("index", "bioprinter", u"PACKAGE_NAME Documentation", [u"Zulko"], 1)]
