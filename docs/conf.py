...
htmlhelp_basename = 'bioprinterdoc'
...
latex_documents = [
  ('index', 'bioprinter.tex', u'bioprinter Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'bioprinter', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'bioprinter', u'bioprinter Documentation',
   u'Zulko', 'bioprinter', 'One line description of project.',
   'Miscellaneous'),
]
